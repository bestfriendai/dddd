...
[![Deploy to Railway](https://img.shields.io/badge/Deploy%20to-Railway-purple.svg)](https://railway.app)
[![Deploy to Vercel](https://img.shields.io/badge/Deploy%20to-Vercel-black.svg)](https://vercel.com)

> Privacy-focused AI research platform powered by advanced language models

**PrivateSearch** is an AI-powered deep research platform that combines privacy-focused search engines with advanced language models to conduct comprehensive research while protecting user privacy. Built on the foundation of DeerFlow, it offers a complete solution for intelligent information gathering and analysis.

🚀 **[Quick Deploy Guide](VERCEL_DEPLOYMENT.md)** | 📖 **[Full Documentation](DEPLOYMENT.md)** | 🔧 **[Configuration Guide](docs/configuration_guide.md)**
...
Deploy DeerFlow to the cloud using our hybrid approach with Vercel (frontend) and Railway (backend):

### 🚀 Quick Deploy

1. **Backend to Railway**: Deploy the Python API server
2. **Frontend to Vercel**: Deploy the Next.js web application
3. **Configure**: Set up environment variables and CORS

### 📖 Deployment Guides

- **[Quick Start Guide](VERCEL_DEPLOYMENT.md)** - Get deployed in 10 minutes
- **[Detailed Guide](DEPLOYMENT.md)** - Complete deployment instructions
- **[Configuration Checker](check-deployment.py)** - Verify your setup
...
- **API Keys**: Tavily (search), OpenAI/LLM provider
- **Accounts**: Vercel and Railway (free tiers available)
- **Repository**: GitHub repository with your DeerFlow code

Run the deployment checker to verify your setup:
